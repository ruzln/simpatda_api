@extends('layouts.app')
@section('page-title', 'Office Assessment')
@section('content')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Ringkasan SKPRD</h1>
    </div>
-->
    <!-- Preset Filter -->
<div class="row mb-2 ">
    <div class="col">
        <button class="btn btn-primary btn-sm" onclick="setPresetTanggal('today')"> Hari ini  </button>
        <button class="btn btn-primary btn-sm" onclick="setPresetTanggal('month')"> Bulan ini </button>
        <button class="btn btn-primary btn-sm" onclick="setPresetTanggal('year')"> Tahun ini  </button>
    </div>
</div>
<div class="row mb-2 align-items-end">
    ...
    <!-- Summary Cards card border-left-primary shadow h-100 py-2-->
...
@push('scripts')
<script src="{{ asset('js/skprd/office.js') }}"></script>
@endpush
